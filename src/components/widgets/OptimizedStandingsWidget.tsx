    ...
    >
      ...
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-sm font-bold text-neutral-900">LaLiga</span>
        </div>
        <div className="text-xs text-neutral-500">J34</div>
      </div>
        ...
        {dummyTable.map((team, i) => (
          <motion.div
            ...
            className={`flex items-center justify-between p-2 rounded-lg transition-all duration-300 ${
              i < 4 ? 'bg-green-50 border border-green-100' : 
              i < 6 ? 'bg-blue-50 border border-blue-100' :
              'bg-white border border-transparent hover:bg-neutral-50'
            }`}
          >
            {/* Left: Position + Team */}
            ...
            <div className="flex items-center space-x-2 text-xs">
              <div className="text-neutral-500 w-4 text-center">{team.played}</div>
              <div className="text-neutral-500 w-6 text-center">
                {team.gd > 0 ? '+' : ''}{team.gd}
              </div>
